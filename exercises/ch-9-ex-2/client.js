...
app.get("/produce", function (req, res) {
  ...
  var resource = request("GET", produceApi, { headers: headers });
...
app.get("/favorites", function (req, res) {
  ...
  var resource = request("GET", favoritesApi, { headers: headers });
  ...
  if (resource.statusCode >= 200 && resource.statusCode < 300) {
    ...
    res.render("favorites", {
      scope: scope,
      data: { user: "", favorites: { movies: [], foods: [], music: [] } },
    });
    return;
  }
});
